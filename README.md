...
*KuRoNeko S* currently consists of two parts:
...
- Downloads with the previous version of KuRoNeko were unstable, the web-application uses technology tailored for the web
